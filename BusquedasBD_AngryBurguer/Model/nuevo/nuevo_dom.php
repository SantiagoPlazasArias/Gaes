...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $insercion = $miPDO->prepare('INSERT INTO domicilios (Nombre, Documento_Identidad, Telefono, Correo, Direccion, Cobertura) VALUES (:Nombre, :Documento_Identidad, :Telefono, :Correo, :Direccion,:Cobertura)');
...
<form action="" method="POST">
    ...
    <ul>
        ...
        <input id="Cobertura" name="Cobertura" type="text">
        </li>
